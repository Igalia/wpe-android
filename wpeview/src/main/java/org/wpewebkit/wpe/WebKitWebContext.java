...
public final class WebKitWebContext {
    public interface Client {
        ...
        @Nullable WebKitWebView createWebKitWebViewForAutomation();
    }
    ...
    public WebKitWebContext(boolean automationMode) { nativePtr = nativeInit(automationMode); }
    ...
    public boolean isAutomationMode() { return nativeIsAutomationMode(nativePtr); }
    ...
    private long createWebKitWebViewForAutomation() {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            WebKitWebView webView = client.createWebKitWebViewForAutomation();
            return webView != null ? webView.getNativePtr() : 0;
        }
        ...
        MainLooperDispatcher.post(() -> {
            WebKitWebView webView = client.createWebKitWebViewForAutomation();
            webViewPtr.set(webView != null ? webView.getNativePtr() : 0);
            latch.countDown();
        });
