...
public class WebContext {
    ...
    public WebContext(@NonNull android.content.Context context, boolean automationMode) {
        ...
        // Emulators typically lack hardware-backed persistent storage; use an ephemeral session to avoid
        // crashes when WebKit tries to create mmap-backed cache files on emulated filesystems.
        // TODO: expose this as a caller-supplied flag instead of relying on fragile build properties.
