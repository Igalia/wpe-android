...
/**
 * ChromeClient provides callbacks for UI events.
 */
public class ChromeClient {
    ...
    public void onUriChanged(@NonNull WebView view, @NonNull String uri) {}

    public interface CustomViewCallback {
        void onCustomViewHidden();
    }

    // TODO: wire WebKit enter-fullscreen / leave-fullscreen signals to invoke these callbacks.
