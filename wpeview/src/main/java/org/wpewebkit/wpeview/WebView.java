...
public class WebView extends FrameLayout {
    ...
    private void init(@NonNull WebContext context, boolean ownsContext) {
        ...
        this.wpeToplevel = new WPEToplevel(wpeContext.getWPEDisplay());

        DisplayMetrics dm = getResources().getDisplayMetrics();
        this.wpeToplevel.setScale(dm.density);

        this.webKitWebView =
            new WebKitWebView(wpeContext.getWPEDisplay(), wpeContext.getWebKitWebContext(), wpeToplevel,
    ...
    private class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            if (platformView != null && wpeToplevel != null) {
                wpeToplevel.onSurfaceCreated(holder.getSurface());
        ...
        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            if (platformView != null) {
                platformView.resized(width, height);
            }
        }
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            if (webKitWebView != null) {
                webKitWebView.setZoomLevel(scaleFactor);
            }
            if (wpeToplevel != null) {
                wpeToplevel.setScale(scaleFactor);
            }
            return true;
        }
    }
