...
private:
    ...
    static void onEvalJavascriptReady(GObject* object, GAsyncResult* result, gpointer userData) noexcept;
    ...
    static void nativeLoadUrl(JNIEnv*, jobject, jlong nativePtr, jstring url) noexcept;
    static void nativeLoadHtml(JNIEnv*, jobject, jlong nativePtr, jstring content, jstring baseUri) noexcept;
    static void nativeStopLoading(JNIEnv*, jobject, jlong nativePtr) noexcept;
    static void nativeReload(JNIEnv*, jobject, jlong nativePtr) noexcept;
    static void nativeGoBack(JNIEnv*, jobject, jlong nativePtr) noexcept;
    static void nativeGoForward(JNIEnv*, jobject, jlong nativePtr) noexcept;
    static jlong nativeGetWebKitWebViewPtr(JNIEnv*, jobject, jlong nativePtr) noexcept;
    static jlong nativeGetWPEView(JNIEnv*, jobject, jlong nativePtr) noexcept;
    static void nativeSetZoomLevel(JNIEnv*, jobject, jlong nativePtr, jdouble zoomLevel) noexcept;
    static void nativeEvaluateJavascript(JNIEnv* env, jobject, jlong nativePtr, jstring script,
...
void JNIWebKitWebViewCache::onEvalJavascriptReady(GObject* object, GAsyncResult* result, gpointer userData) noexcept
{
...
void JNIWebKitWebViewCache::nativeDestroy(JNIEnv*, jobject, jlong nativePtr) noexcept
{
...
jlong JNIWebKitWebViewCache::nativeGetWebKitWebViewPtr(JNIEnv*, jobject, jlong nativePtr) noexcept
{
