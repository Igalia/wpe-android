...
static void onClose(WebKitWebView* webView, jobject javaRef)
{
...
static void onUriChanged(GObject* obj, GParamSpec* spec, jobject javaRef)
{
    UNUSED_PARAM(spec);
    if (!obj)
        return;
...
static void onEstimatedLoadProgress(GObject* obj, GParamSpec* spec, jobject javaRef)
{
    UNUSED_PARAM(spec);
    if (!obj)
        return;
...
static void onTitleChanged(GObject* obj, GParamSpec* spec, jobject javaRef)
{
    UNUSED_PARAM(spec);
    if (!obj)
        return;
...
static gboolean handleDecidePolicyForHttpError(
    WebKitWebView* webView, WebKitPolicyDecision* decision, WebKitPolicyDecisionType decisionType, jobject javaRef)
{
    UNUSED_PARAM(webView);
...
void JNIWebKitWebViewCache::nativeDestroy(JNIEnv* env, jobject jniObject, jlong nativePtr) noexcept
{
...
void JNIWebKitWebViewCache::nativeLoadUrl(JNIEnv* env, jobject jniObject, jlong nativePtr, jstring url) noexcept
{
    UNUSED_PARAM(env);
    UNUSED_PARAM(jniObject);
    auto* webView = reinterpret_cast<WebKitWebView*>(nativePtr);
...
void JNIWebKitWebViewCache::nativeLoadHtml(
    JNIEnv* env, jobject jniObject, jlong nativePtr, jstring content, jstring baseUri) noexcept
{
    UNUSED_PARAM(env);
    UNUSED_PARAM(jniObject);
    auto* webView = reinterpret_cast<WebKitWebView*>(nativePtr);
...
void JNIWebKitWebViewCache::nativeStopLoading(JNIEnv* env, jobject jniObject, jlong nativePtr) noexcept
{
    UNUSED_PARAM(env);
    UNUSED_PARAM(jniObject);
    auto* webView = reinterpret_cast<WebKitWebView*>(nativePtr);
...
void JNIWebKitWebViewCache::nativeReload(JNIEnv* env, jobject jniObject, jlong nativePtr) noexcept
{
    UNUSED_PARAM(env);
    UNUSED_PARAM(jniObject);
    auto* webView = reinterpret_cast<WebKitWebView*>(nativePtr);
...
void JNIWebKitWebViewCache::nativeGoBack(JNIEnv* env, jobject jniObject, jlong nativePtr) noexcept
{
    UNUSED_PARAM(env);
    UNUSED_PARAM(jniObject);
    auto* webView = reinterpret_cast<WebKitWebView*>(nativePtr);
...
void JNIWebKitWebViewCache::nativeGoForward(JNIEnv* env, jobject jniObject, jlong nativePtr) noexcept
{
    UNUSED_PARAM(env);
    UNUSED_PARAM(jniObject);
    auto* webView = reinterpret_cast<WebKitWebView*>(nativePtr);
...
jlong JNIWebKitWebViewCache::nativeGetWPEView(JNIEnv* env, jobject jniObject, jlong nativePtr) noexcept
{
    UNUSED_PARAM(env);
    UNUSED_PARAM(jniObject);
    auto* webView = reinterpret_cast<WebKitWebView*>(nativePtr);
...
void JNIWebKitWebViewCache::nativeSetZoomLevel(
    JNIEnv* env, jobject jniObject, jlong nativePtr, jdouble zoomLevel) noexcept
{
    UNUSED_PARAM(env);
    UNUSED_PARAM(jniObject);
    auto* webView = reinterpret_cast<WebKitWebView*>(nativePtr);
...
void JNIWebKitWebViewCache::nativeEvaluateJavascript(JNIEnv* env, jobject jniObject, jlong nativePtr, jstring script,
    JNIWebKitWebViewEvalCallbackHolder callbackHolder) noexcept
{
    UNUSED_PARAM(jniObject);
    auto* webView = reinterpret_cast<WebKitWebView*>(nativePtr);
