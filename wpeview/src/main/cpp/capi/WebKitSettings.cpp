...
private:
    ...
    static void nativeDestroy(JNIEnv* env, jobject jniObject, jlong settingsPtr) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
    ...
    static jstring nativeGetUserAgentString(JNIEnv* env, jobject jniObject, jlong settingsPtr) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
        auto* settings = reinterpret_cast<WebKitSettings*>(settingsPtr);
    ...
    static void nativeSetUserAgentString(JNIEnv* env, jobject jniObject, jlong settingsPtr, jstring userAgent) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
        auto* settings = reinterpret_cast<WebKitSettings*>(settingsPtr);
    ...
    static jboolean nativeGetMediaPlaybackRequiresUserGesture(
        JNIEnv* env, jobject jniObject, jlong settingsPtr) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
        auto* settings = reinterpret_cast<WebKitSettings*>(settingsPtr);
    ...
    static void nativeSetMediaPlaybackRequiresUserGesture(
        JNIEnv* env, jobject jniObject, jlong settingsPtr, jboolean requires) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
        auto* settings = reinterpret_cast<WebKitSettings*>(settingsPtr);
    ...
    static jboolean nativeGetAllowUniversalAccessFromFileURLs(
        JNIEnv* env, jobject jniObject, jlong settingsPtr) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
    ...
    static void nativeSetAllowUniversalAccessFromFileURLs(
        JNIEnv* env, jobject jniObject, jlong settingsPtr, jboolean flag) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
        auto* settings = reinterpret_cast<WebKitSettings*>(settingsPtr);
    ...
    static jboolean nativeGetAllowFileAccessFromFileURLs(JNIEnv* env, jobject jniObject, jlong settingsPtr) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
        auto* settings = reinterpret_cast<WebKitSettings*>(settingsPtr);
    ...
    static void nativeSetAllowFileAccessFromFileURLs(
        JNIEnv* env, jobject jniObject, jlong settingsPtr, jboolean flag) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
    ...
    static jboolean nativeGetDeveloperExtrasEnabled(JNIEnv* env, jobject jniObject, jlong settingsPtr) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
        auto* settings = reinterpret_cast<WebKitSettings*>(settingsPtr);
    ...
    static void nativeSetDeveloperExtrasEnabled(
        JNIEnv* env, jobject jniObject, jlong settingsPtr, jboolean flag) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
    ...
    static jboolean nativeGetDisableWebSecurity(JNIEnv* env, jobject jniObject, jlong settingsPtr) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
        auto* settings = reinterpret_cast<WebKitSettings*>(settingsPtr);
    ...
    static void nativeSetDisableWebSecurity(
        JNIEnv* env, jobject jniObject, jlong settingsPtr, jboolean disable) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
        auto* settings = reinterpret_cast<WebKitSettings*>(settingsPtr);
