...
DECLARE_JNI_CLASS_SIGNATURE(JNIWebKitWebsiteDataManagerCallbackHolder,
    "org/wpewebkit/wpe/WebKitWebsiteDataManager$CallbackHolder");
...
private:
        ...
        JNIWebKitWebsiteDataManagerCallbackHolder callbackHolder) noexcept
    {
        ...
        webkit_website_data_manager_clear(manager, values, 0, nullptr, reinterpret_cast<GAsyncReadyCallback>(onClearReady),
