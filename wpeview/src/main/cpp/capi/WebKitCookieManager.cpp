...
private:
    ...
    static jlong nativeInit(JNIEnv* env, jobject jniObject, jlong sessionPtr)
    {
        UNUSED_PARAM(env);
    ...
    static void nativeGetAcceptPolicy(JNIEnv* env, jobject jniObject, jlong nativePtr,
        JNIWebKitCookieManagerAcceptPolicyCallbackHolder callbackHolder) noexcept
    {
        UNUSED_PARAM(jniObject);
    ...
    static void nativeSetAcceptPolicy(JNIEnv* env, jobject jniObject, jlong nativePtr, jint policy) noexcept
    {
        UNUSED_PARAM(env);
        UNUSED_PARAM(jniObject);
        auto* cookieManager = reinterpret_cast<WebKitCookieManager*>(nativePtr);
