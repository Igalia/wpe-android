...
private:
    const JNI::Method<void(jint)> m_commitResult; // NOLINT(cppcoreguidelines-avoid-const-or-ref-data-members)
};
...
private:
    ...
    static void nativeGetAcceptPolicy(
        JNIEnv* env, jobject, jlong nativePtr, JNIWebKitCookieManagerAcceptPolicyCallbackHolder callbackHolder)
    {
    ...
    static void nativeSetAcceptPolicy(JNIEnv*, jobject, jlong nativePtr, jint policy)
    {
