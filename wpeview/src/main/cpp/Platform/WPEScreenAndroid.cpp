...
static void wpeScreenAndroidInvalidate(WPEScreen*)
{
}
...
static WPEScreenSyncObserver* wpeScreenAndroidGetSyncObserver(WPEScreen* screen)
{
    ...
    return static_cast<WPEScreenSyncObserver*>(g_object_ref(screenAndroid->syncObserver));
}
...
{
    // TODO: Get actual scale and refresh rate via Android Display APIs / JNI.
...
{
    return WPE_SCREEN(g_object_new(WPE_TYPE_SCREEN_ANDROID, nullptr));
}
