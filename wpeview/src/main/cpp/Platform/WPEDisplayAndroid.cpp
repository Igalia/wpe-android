...
static gboolean wpeDisplayAndroidUseExplicitSync(WPEDisplay* display)
{
...
static WPEBufferFormats* wpeDisplayAndroidGetPreferredBufferFormats(WPEDisplay* display)
{
    ...
    // Android does not use DRM modifiers.
...
static WPEToplevel* wpeDisplayAndroidCreateToplevel(WPEDisplay* display, guint nth)
{
    UNUSED_PARAM(nth);
...
{
    // TODO: Support WPE_AVAILABLE_INPUT_DEVICE_MOUSE when one is connected.
